...
await import('./apply-landmark-y-list-actual-data-and-sync-silence-fix.mjs')
await import('./apply-polygon-visibility-and-y-order-final-fix.mjs')
await import('./apply-landmark-y-shift-capture-final.mjs')
await import('./apply-auth-env-compat-fix.mjs')
